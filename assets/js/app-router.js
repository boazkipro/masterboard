...
app.run(["app","$rootScope","$location", "formlyConfig","formlyValidationMessages","$localStorage", "scrum",function( app, $rootScope, $location, formlyConfig, formlyValidationMessages,$localStorage, scrum ){
